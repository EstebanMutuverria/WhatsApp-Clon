...
import ContactFilters from '../ContactFilters/ContactFilter'
/* 
    ...
    return (
        <aside className='contact-side-bar-container'>
            ...
            <div className='contact-list-scroll'>
                <ContactList contactState = {contactState} loadingContactState = {loadingContactState}/>
            </div>
        </aside>
    )
}
