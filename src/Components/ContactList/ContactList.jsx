...
export default function ContactList() {
    const { contactState, filterContacts } = useContext(ContactListContext)
    return (
        <div>
            {
                contactState.map(
                    function (contact) {
                        return (
                            <Link to={'/chat/' + contact.contact_id + '/messages'} key={contact.contact_id} className='chat-container' onClick={() => filterContacts('')}>
                                <div>
