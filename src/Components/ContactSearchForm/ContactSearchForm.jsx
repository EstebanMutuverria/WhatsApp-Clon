...
export default function ContactSearchForm() {
    return (
        <div className="csf-container">
            ...
            {/* --- FILTER ICON (WhatsApp Web tiene este icono al lado) --- */}
